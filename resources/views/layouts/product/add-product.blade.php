        ...
        <div class="hall-second">
                    ...
                    <div class="container">
                        ...
                        <div class="card">
                            <div class="mb-2">
                                ...
                                <input type="SKU" class="form-control beda" value="BM0011">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <select name="" id="jenisproduk" class="form-select">
                                    <option value="">NC</option>
                                    <option value="">NC MTH</option>
                        ...
                        <div class="card">
                            <div class="mb-2">
                                ...
                                <input type="NamaProduk" class="form-control beda" placeholder="B/N 5/16” x 7”">
                            </div>
                            <div class="mb-2">
                                <label for="" class="form-label"> Ukuran </label>
                                <select name="" id="" class="form-select">
                                    <option value="">5/16” x 7”</option>
                                </select>
                            </div>
                            <div class="mb-2">
                                <label for="" class="form-label"> Pitch </label>
                                <select name="pitch" id="pitch" class="form-select">
                                    <option value="">PO,01</option>
                                    <option value="">PO,1</option>
                                    <option value="">PO,15</option>
                                </select>
                            </div>
                            <div class="mb-2">
            ...
            <div class="section sectionprofil-5 bagianya">
                <div class="grid">
                    <div class="bagian1">
                        <div class="isi">
                            <h1>Apakah Produk dapat dibeli secara terpisah antara Bolt dan Nuts nya ?</h1>
                            <div class="radio-group">
                                <label class="radio-container">
                                    <input type="radio" name="option" value="ya" onclick="toggleSections('bagianya')">
                                    <span class="custom-radio"></span> Ya
                                </label>
                                <label class="radio-container">
                                    <input type="radio" name="option" value="tidak" onclick="toggleSections('bagiantidak')">
                                    <span class="custom-radio"></span> Tidak
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="containergrid">
                            <div class="gridku">
                                ...
                                <select name="" id="" class="form-select">
                                    ...
                                    <option value="">INSASTAMA</option>
                                </select>
                            </div>
                            <div class="gridku">
                                <label for="" class="form-label">
                                    Harga per Biji </label>
                    ...
                    <div class="bagian1">
                        <div class="containergrid">
                            <div class="gridku ">
                                <label for="" class="form-label">
                                    Berat 1 set Baut </label>
                                <div class="input-group  ">
                                    <input type="text" class="form-control beda" value="0">
                                    <span class="input-group-text beda ">gram</span>
                                </div>
                            </div>
                            <div class="gridku beda">
                                <label for="" class="form-label">
                                    Berat Baut </label>
                                <div class="input-group ">
                                    <input type="text" class="form-control beda" value="0">
            ...
            <div class="section sectionprofil-4 hidden bagiantidak">
                <div class="grid">
                    <div class="container">
                        <div class="card">
                            <div class="containerr">
                        ...
                        <div class="card">
                            ...
                            <div class="mb-2">
                                <label for="" class="form-label"> Warna & Pitch </label>
                                <select name="warna" id="warna" class="form-select">
                                    <option value="">Hitam</option>
                                    <option value="">Silver</option>
                                    <option value="">Abu Abu</option>
            ...
            <div class="section sectionprofil-5 hidden bagiantidak">
                <div class="grid">
                    <div class="bagian1">
                        <div class="isi">
                            <h1>Apakah Produk dapat dibeli secara terpisah antara Bolt dan Nuts nya ?</h1>
