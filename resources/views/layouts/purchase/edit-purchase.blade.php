                    ...
                    <div class="col-4 mt-2">
                        ...
                        <div class="custom-dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li><a class="dropdown-item">Produk A </a></li>
                                <hr class="solid">
                                <li><a class="dropdown-item">Produk B</a></li>
                                <hr class="solid">
                                <li><a class="dropdown-item">Produk C</a></li>
                                <hr class="solid">
                                <li><a class="dropdown-item customer" data-bs-toggle="modal" data-bs- dismiss="Modal" data-bs-target="#supplierbaru">+ Supplier Baru</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="sectionprofil-6">
                <div class="containerr table-container active">
                    <div class="linebox">
                        <div class="top-grid">
                            <h5>Daftar Produk</h5>
                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#scanpembelianModal">
                                + Produk
                            </a>
                        </div>
