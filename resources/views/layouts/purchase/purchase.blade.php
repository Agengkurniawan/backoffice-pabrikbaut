                    ...
                    <div class="row top-selection">
                        ...
                        <div class="col-2 mt-2">
                            <select id="filterCreator" class="form-select Creator">
                                ...
                                <option value="Sari Melati">Sari Melati</option>
                                <option value="Nina Ayu">Nina Ayu</option>
                        ...
                        <div class="col mt-2">
                            <a href="/purchase/edit-purchase" class="pembelian">+ Pembelian</a>
                        </div>
                    </div>
                    <hr class="solid">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="/purchase/detail-purchase/process">Detail</a></li>
                                                <hr class="solid">
                                                <li><a class="dropdown-item" href="/purchase/edit-purchase">Edit</a></li>
                                                <hr class="solid">
                                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#ubahStatuspembelianModal">Ubah Status</a></li>
                                                <hr class="solid">
                                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-dismiss="modal" data-bs-target="#konfirmasiHapusModal">Hapus</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
