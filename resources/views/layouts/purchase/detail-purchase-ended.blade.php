                ...
                <div class="containerr">
                    <div id="produkTablecontainer" class="tab-content active" {{ Request::is('purchase/detail-pending-produk') ? 'active' : '' }}>
                        <div class="top-grid">
                            ...
                            <div class="grid">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#surattandaterimapembelian" class=" tab-buttonn grid2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                        <path d="M6.21777 5.2175C5.90277 5.2175 5.65527 4.9625 5.65527 4.655V2.5625C5.65527 2.255 5.90277 2 6.21777 2C6.53277 2 6.78027 2.255 6.78027 2.5625V4.6475C6.78027 4.9625 6.53277 5.2175 6.21777 5.2175Z" fill="white" />
                                        <path d="M11.7822 5.2175C11.4672 5.2175 11.2197 4.9625 11.2197 4.655V2.5625C11.2197 2.2475 11.4747 2 11.7822 2C12.0972 2 12.3447 2.255 12.3447 2.5625V4.6475C12.3447 4.9625 12.0972 5.2175 11.7822 5.2175Z" fill="white" />
                                        <path d="M14.6775 3.875C14.1825 3.5075 13.47 3.86 13.47 4.4825V4.5575C13.47 5.435 12.84 6.245 11.9625 6.335C10.95 6.44 10.095 5.645 10.095 4.655V3.875C10.095 3.4625 9.7575 3.125 9.345 3.125H8.655C8.2425 3.125 7.905 3.4625 7.905 3.875V4.655C7.905 5.2475 7.5975 5.7725 7.1325 6.065C7.065 6.11 6.99 6.1475 6.915 6.185C6.8475 6.2225 6.7725 6.2525 6.69 6.275C6.6 6.305 6.5025 6.3275 6.3975 6.335C6.2775 6.35 6.1575 6.35 6.0375 6.335C5.9325 6.3275 5.835 6.305 5.745 6.275C5.67 6.2525 5.595 6.2225 5.52 6.185C5.445 6.1475 5.37 6.11 5.3025 6.065C4.83 5.735 4.53 5.165 4.53 4.5575V4.4825C4.53 3.905 3.915 3.56 3.4275 3.8075C3.42 3.815 3.4125 3.815 3.405 3.8225C3.375 3.8375 3.3525 3.8525 3.3225 3.875C3.3 3.8975 3.27 3.9125 3.2475 3.935C3.0375 4.1 2.85 4.2875 2.6925 4.49C2.61 4.58 2.5425 4.6775 2.4825 4.775C2.475 4.7825 2.4675 4.79 2.46 4.805C2.3925 4.9025 2.3325 5.015 2.28 5.12C2.265 5.135 2.2575 5.1425 2.2575 5.1575C2.2125 5.2475 2.1675 5.3375 2.1375 5.435C2.115 5.4725 2.1075 5.5025 2.0925 5.54C2.0475 5.6525 2.0175 5.765 1.9875 5.8775C1.9575 5.9825 1.935 6.095 1.92 6.2075C1.905 6.29 1.8975 6.3725 1.89 6.4625C1.8825 6.5675 1.875 6.6725 1.875 6.7775V13.3475C1.875 15.365 3.51 17 5.5275 17H12.4725C14.49 17 16.125 15.365 16.125 13.3475V6.7775C16.125 5.585 15.555 4.5425 14.6775 3.875ZM9 13.565H5.52C5.2125 13.565 4.9575 13.31 4.9575 13.0025C4.9575 12.6875 5.2125 12.4325 5.52 12.4325H9C9.315 12.4325 9.5625 12.6875 9.5625 13.0025C9.5625 13.31 9.315 13.565 9 13.565ZM11.085 10.7825H5.52C5.2125 10.7825 4.9575 10.5275 4.9575 10.22C4.9575 9.905 5.2125 9.65 5.52 9.65H11.085C11.4 9.65 11.655 9.905 11.655 10.22C11.655 10.5275 11.4 10.7825 11.085 10.7825Z" fill="white" />
                                    </svg> Surat Tanda Terima</a>
                                <a href="#" class="tab-buttonn " data-bs-target="#konfirmasipengirimanPO" data-bs-toggle="modal">
