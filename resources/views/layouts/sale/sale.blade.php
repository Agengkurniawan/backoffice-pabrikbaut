                    ...
                    <div class="row top-selection">
                        ...
                        <div class="col-1 mt-2">
                            <select id="filterCV" class="form-select CV">
                                ...
                                <option value="CV Rafko Gap">CV Rafko Gap</option>
                                <option value="CV Indobolt">CV Indobolt</option>
                                <option value="CV Dukuh Baut">CV Dukuh Baut</option>
                                <option value="CV Grafta Jodi">CV Grafta Jodi</option>
                            </select>
                        </div>
                        <div class="col-2 mt-2">
                        ...
                        <div class="col mt-2">
                            <a href="/sale/edit" class="penjualan">+ Penjualan</a>
                        </div>
                    </div>
                    <hr class="solid">
                        ...
                        <table id="salesTable" class="table table-striped">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="/sale/detail-disiapkan">Detail</a></li>
                                                <hr class="solid">
                                ...
                                <tr>
                                    ...
                                    <td>20/01/2025</td>
                                    <td>Nina Ayu</td>
                                    <td>CV Indobolt <span>PPN</span></td>
                                    <td>Rudi Hartono</td>
                                    <td>5 Produk</td>
                                    <td>Rp 4.340.000</td>
                                    <td><span class="badge badge-silver">Pending</span></td>
                                    <td>
                                        <div class="dropdown">
                                            <button class="dropdownn" type="button" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                                    <path d="M5.5 10.25C4.4 10.25 3.5 11.15 3.5 12.25C3.5 13.35 4.4 14.25 5.5 14.25C6.6 14.25 7.5 13.35 7.5 12.25C7.5 11.15 6.6 10.25 5.5 10.25Z" stroke="#292D32" stroke-width="1.5" />
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="/sale/detail-pending">Detail</a></li>
                                                <hr class="solid">
