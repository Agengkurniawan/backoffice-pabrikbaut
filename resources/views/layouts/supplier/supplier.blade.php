                ...
                <div class="containerr">
                    <div id="productTablecontainer" class="tab-content active" {{ Request::is('product') ? 'active' : '' }}>
                        <div class="bagiansearch">
                            ...
                            <a href="#" data-bs-target="#tambahsupplier" data-bs-toggle="modal">+ Supplier</a>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <span id="productTable_paginate" class="mr-2">1-10 of 120 Items</span>
