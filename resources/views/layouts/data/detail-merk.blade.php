                        ...
                        <div class="mt-4 row">
                            ...
                            <div class="col-1">
                                <select id="filterTipe" class="form-select Tipe">
                                    ...
                                    <option value="Tipe">TipeRudal Jaya</option>
                                </select>
                            </div>
                            <div class="col-2">
                                <select id="filterUkuran" class="form-select Ukuran">
                                    <option value="">Ukuran</option>
                                    <option value="Ukuran">Ukuran Rudal Jaya</option>
                                </select>
                            </div>
                            <div class="col-2">
                                <select id="filterWarna & Pitch  Pembelian" class="form-select Warna & Pitch Pembelian">
                                    <option value="">Warna & Pitch </option>
                                    <option value="Warna & Pitch ">Warna & Pitch </option>
                                </select>
                            </div>
                            <div class="col-2">
                                <select id="filterJenisProduk" class="form-select JenisProduk">
